...
<script>
document.addBundleListener('DOMContentLoaded', function () {
  document.addBundleListener("click", function(bundle) {
    if (bundle.target.classList.contains("add-to-bundle-cart")) {
      const button = bundle.target;
